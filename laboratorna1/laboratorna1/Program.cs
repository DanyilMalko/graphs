...
namespace laboratorna1
{
	class Graph
	{
		...
		public static void Main(String[] args)
		{
			...
			graph.edge[2].src = 3;
			graph.edge[2].dest = 4;
			graph.edge[2].weight = 53;
			
			graph.edge[3].src = 4;
			graph.edge[3].dest = 2;
			graph.edge[3].weight = 23;
			...
			graph.edge[5].src = 6;
			graph.edge[5].dest = 7;
			graph.edge[5].weight = 99;

			graph.edge[6].src = 7;
			graph.edge[6].dest = 5;
			graph.edge[6].weight = 25;

			graph.edge[7].src = 5;
			graph.edge[7].dest = 0;
			graph.edge[7].weight = 34;

			graph.edge[8].src = 0;
			graph.edge[8].dest =7;
			graph.edge[8].weight = 80;

			graph.edge[9].src = 1;
			graph.edge[9].dest = 7;
			graph.edge[9].weight = 68;

			graph.edge[10].src = 3;
			graph.edge[10].dest = 7;
			graph.edge[10].weight = 39;
